...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'Logistic Regression': [
            { 'epochs': 10, 'stepsize': 0.001 },
            { 'epochs': 10, 'stepsize': 0.005 },            
            { 'epochs': 100, 'stepsize': 0.01 },
            { 'epochs': 10, 'stepsize': 0.05 },            
        ],
        ...
        'Linear Kernel Logistic Regression': [
            { 'epochs': 10, 'centers': 10, 'stepsize': 0.01 },
            { 'epochs': 10, 'centers': 20, 'stepsize': 0.01 },
            { 'epochs': 40, 'centers': 40, 'stepsize': 0.01 },
            { 'epochs': 10, 'centers': 80, 'stepsize': 0.01 },
        ],
        'Hamming Distance Kernel Logistic Regression': [
            { 'epochs': 10, 'centers': 10, 'stepsize': 0.01 },
            { 'epochs': 10, 'centers': 20, 'stepsize': 0.01 },
            { 'epochs': 10, 'centers': 40, 'stepsize': 0.01 },
            { 'epochs': 10, 'centers': 80, 'stepsize': 0.01 },
        ]
    }
